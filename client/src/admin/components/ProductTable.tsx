      ...
      <TableBody>
        {products.map(p => (
          <TableRow key={p.id} hover>
            ...
            <TableCell><Typography fontWeight={600} color="primary">₪{p.price}</Typography></TableCell>
            <TableCell>{p.featured ? <Chip label="כן" color="success" size="small" /> : <Chip label="לא" size="small" />}</TableCell>
